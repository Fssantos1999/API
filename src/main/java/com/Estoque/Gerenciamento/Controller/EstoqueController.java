...
import com.Estoque.Gerenciamento.Service.EstoqueService;
...
public class EstoqueController {
    ...
    public void adicionarProduto(@RequestBody EstoqueService estoqueService) {
    ...
    public void atualizar(@RequestBody Estoque estoque) {
        estoqueService.salvarEstoque(estoque);
    }


    @PostMapping(value = "/api/adicionarEntradaProduto")
    public void entradaProduto(@PathVariable Estoque estoque) {
